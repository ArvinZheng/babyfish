 ...
 * @author Tao Chen
 */
public class JPAObjectModelPropertyAccess implements PropertyAccess {
    
	private Getter getter;
	
	private Setter setter;
	
	JPAObjectModelPropertyAccess(Class<?> theClass, String propertyName) {
		this.getter = determineGetter(theClass, propertyName);
		this.setter = determineSetter(theClass, propertyName);
	}
    ...
    private static Getter determineGetter(Class<?> theClass, String propertyName) {
    ...
    private static Setter determineSetter(Class<?> theClass, String propertyName) {
        for (HibernateObjectModelMetadata objectModelMetadata = HibernateMetadatas.of(theClass);
                objectModelMetadata != null;
                objectModelMetadata = objectModelMetadata.getSuperMetadata()) {
            JPAAssociationProperty jpaAssociationProperty = 
