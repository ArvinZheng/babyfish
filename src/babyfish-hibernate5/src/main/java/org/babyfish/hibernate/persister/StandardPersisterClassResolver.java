...
public class StandardPersisterClassResolver extends org.hibernate.persister.internal.StandardPersisterClassResolver {
	...
	public Class<? extends EntityPersister> singleTableEntityPersister() {
    	return org.babyfish.hibernate.persister.SingleTableEntityPersister.class;
	}

	@Override
	public Class<? extends EntityPersister> joinedSubclassEntityPersister() {
		return org.babyfish.hibernate.persister.JoinedSubclassEntityPersister.class;
	}

	@Override
	public Class<? extends EntityPersister> unionSubclassEntityPersister() {
		return org.babyfish.hibernate.persister.UnionSubclassEntityPersister.class;
	}
