...
public class XEntityManagerFactoryBuilderImpl extends EntityManagerFactoryBuilderImpl {
	...
	// For dynamically generated byte-code because static invocation is easier than constructor invocation
	public static XEntityManagerFactoryBuilderImpl of(
			PersistenceUnitInfo persistenceUnit, 
            Map<?, ?> integrationSettings) {
		return new XEntityManagerFactoryBuilderImpl(
	...
	public static XEntityManagerFactoryBuilderImpl of(
            ...
            Map<?, ?> integrationSettings) {
		return new XEntityManagerFactoryBuilderImpl(persistenceUnit, integrationSettings, null);
	}
	...
	public static XEntityManagerFactoryBuilderImpl of(
            ...
            Map<?, ?> integrationSettings,
            ClassLoader providedClassLoader) {
		return new XEntityManagerFactoryBuilderImpl(persistenceUnit, integrationSettings, providedClassLoader);
	}
    ...
    private XMetadataImplementor metadata() {
    	if ( this.metadata == null ) {
			MetadataImpl hibernateMetadata = (MetadataImpl)
